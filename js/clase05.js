...
imprimir.innerHTML = `La nueva trabajadora de la empresa es: ${trabajadores[4].nombre} y su cargo es Gerente de ${trabajadores[4].cargo} y su teléfono de contacto para consultas es ${trabajadores[4].telefono}`;
